...
let tiertimer = (tier) => {
    switch (Number(tier)) {
        ...
        case 7: return min*999999999999999999
            default:
                return min*10
    }
}
...
client.on("message", async (msg) => {
    if (msg.guild.id !== "986603778029539328") return
    const prefix = "-"
...
client.login("OTM5NTg3OTE2MzExNzExOTI2.Gvse18.4IrNcp8JxCRkcXFkvI1LsWLj78RHJxyB6gBV4o");